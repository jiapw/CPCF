...
* 'configure.py --amalgamation --single-amalgamation-file --disable-shared --no-autoload --enable-modules=auto_rng,rsa,sha1_sse2,sha1,md5,sha2_32,sha2_64,sha3,emsa1,emsa_pkcs1,emsa_pssr,emsa_raw,dh,ecdh,emsa_x931,cryptoapi_rng,crc32,cbc,des,blowfish,curve25519,dsa,win32_stats,aes,aes_ni,aes_ssse3,tls --os=android --cpu=arm64 --link-method=copy --with-local-config=config_ndk.h'
*
* Target
